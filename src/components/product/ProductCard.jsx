  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] rounded-2xl overflow-hidden bg-slate-100">
        ...
        {/* Badges */}
        {product.badge && (
          <div className={`absolute top-3 left-3 px-2 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${product.badge === 'Sale' ? 'bg-red-500 text-white' : 'bg-white text-primary'
            }`}>
            {product.badge}
          </div>
        )}
